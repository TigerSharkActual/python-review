...
namespace estate_executor {
    ...
    int assemble_code() {
        int red_code_fragments = zhang::red::code_fragment() + khan::red::code_fragment() +
                                 garcia::red::code_fragment();
        int blue_code_fragments = zhang::blue::code_fragment() + khan::blue::code_fragment() +
                                  garcia::blue::code_fragment();
        int whole_code = red_code_fragments * blue_code_fragments;
            return whole_code;
    }
}
